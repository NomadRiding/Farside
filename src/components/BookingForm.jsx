...
export default function BookingForm({ onSubmit, loading, apiError }) {
  ...
  const selectedPackage = charterPackages.find((p) => p.id === values.charterType)
    ...
    <form className="booking-form" onSubmit={handleSubmit} noValidate>
      <div className="booking-form__grid">
        ...
        <div className="form-field">
          ...
          <select
            ...
            aria-describedby={errors.charterType ? 'charterType-error' : undefined}
          >
            {charterPackages.map((pkg) => (
      ...
      {selectedPackage && (
        <div className="booking-form__summary" aria-live="polite">
          <p>
            <strong>Total:</strong> ${selectedPackage.price} — {selectedPackage.duration}
          </p>
      ...
      <p className="booking-form__legal">
        By booking, you agree to our cancellation policy. Cancellations made 48+ hours
        before your trip receive a full refund. See our{' '}
